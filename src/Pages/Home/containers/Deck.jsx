...
const cardContent = [
  {
    ...
    starFilled1: "star filled",
    starFilled2: "star filled",
    starFilled3: "star filled",
    starFilled4: "star filled",
    starFilled5: "star ",
    name: "Suzan B.",
...
const Deck = () => {
  ...
  const [props, set] = useSprings(cardContent.length, i => ({ ...to(i), from: from(i) }));
        ...
        <animated.div key={i} style={{ transform: interpolate([x, y], (x, y) => `translate3d(${x}px,${y}px,0)`) }}>
          <animated.div {...bind(i)} style={{ transform: interpolate([rot, scale], trans) }}>
            ...
            <div className="card-contentTxt">
              ...
              <FaStar className={cardContent[i].starFilled1} />
              <FaStar className={cardContent[i].starFilled2} />
              <FaStar className={cardContent[i].starFilled3} />
              <FaStar className={cardContent[i].starFilled4} />
              <FaStar className={cardContent[i].starFilled5} />
